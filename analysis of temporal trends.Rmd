...
```{r}
trenddata<-read.csv("C:/Users/lizzi/Documents/PhD/Data for temporal trends/temporal trend dataset with new method.csv", stringsAsFactors = TRUE)
library(dplyr)
library(tidyr)
library(ggplot2)
library(car)
...
```
```{r}
newmethoddata<-read.csv("C:/Users/lizzi/Documents/PhD/Data for temporal trends/temporal trend dataset with new method.csv", stringsAsFactors = TRUE)
